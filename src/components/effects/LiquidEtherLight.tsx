...
// Tonos dorados brillantes y luminosos - sin tonos oscuros que dejen estelas
const defaultColors = [
  '#FFF9E6', // Cream light - Crema muy claro
  '#FEFCE8', // Cream gold - Brillo superior
  '#FEF3C7', // Light yellow - Amarillo claro
  '#FDE68A', // Soft gold - Oro suave
  '#FACC15', // Yellow gold - Oro amarillo brillante
  '#FBBF24', // Amber bright - Ámbar brillante
  '#F59E0B', // Amber gold - Ámbar dorado
  '#FFD700'  // Pure gold - Oro puro brillante
];
...
export default function LiquidEther({
  ...
  useEffect(() => {
    ...
    // Fondo blanco crema para modo claro (#FAF8F3 = rgb(250, 248, 243))
    const bgVec4 = new THREE.Vector4(250/255, 248/255, 243/255, 1);
    ...
    class CommonClass {
      ...
      init(container: HTMLElement) {
        ...
        // Fondo blanco crema para modo claro (#FAF8F3)
        this.renderer.autoClear = false;
        this.renderer.setClearColor(new THREE.Color(0xFAF8F3), 1);
