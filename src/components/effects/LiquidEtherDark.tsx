...
// Tonos rojos laboratorio elegantes - variaciones de rojo oscuro a brillante con toques carmesí
const defaultColors = [
  '#8B0000', // Dark Red - Base profunda
  '#A52A2A', // Brown Red - Tono cálido
  '#B22222', // Firebrick - Rojo intenso
  '#DC143C', // Crimson - Carmesí vibrante
  '#C41E3A', // Cardinal Red - Rojo cardenal
  '#800020', // Burgundy - Burgundy profundo
  '#8B2500', // Orange Red Dark - Tono laboratorio
  '#CC0000'  // Red Bright - Rojo brillante para contraste
];
