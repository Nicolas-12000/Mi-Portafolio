    ...
    <section id="profile" className="py-12 sm:py-16 md:py-20 bg-gradient-to-b from-background to-surface">
      <div className="max-w-7xl mx-auto px-4 sm:px-6">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 sm:gap-8 mb-10 sm:mb-12 md:mb-16">
          {/* Engineer Side */}
          <div className="bg-surface-elevated/60 backdrop-blur-lg rounded-xl border border-border p-4 sm:p-6 md:p-8">
            ...
            <div className="space-y-4 sm:space-y-6">
              <div>
                <div className="flex items-center gap-2 mb-2">
                  ...
                  <h4 className="font-semibold text-accent-primary text-sm sm:text-base">{t('engineer.location.title')}</h4>
                </div>
              ...
              <div>
                <div className="flex items-center gap-2 mb-2">
                  ...
                  <h4 className="font-semibold text-accent-primary text-sm sm:text-base">{t('engineer.experience.title')}</h4>
                </div>
                <p className="text-text-tertiary text-sm leading-relaxed">{t('engineer.experience.description')}</p>
              </div>
              
              <div>
                <h4 className="font-semibold text-accent-primary mb-2 text-sm sm:text-base">{t('engineer.methods.title')}</h4>
                <p className="text-text-tertiary text-sm leading-relaxed">{t('engineer.methods.description')}</p>
              </div>
              
              <div>
                <h4 className="font-semibold text-accent-primary mb-2 text-sm sm:text-base">{t('engineer.projects.title')}</h4>
          ...
          <div className="space-y-4 sm:space-y-6">
            <div className="bg-surface-elevated/60 backdrop-blur-lg rounded-xl border border-border p-4 sm:p-6 md:p-8">
              ...
              <div className="text-text-tertiary text-sm leading-relaxed mb-4 sm:mb-6 space-y-2 sm:space-y-3">
                ...
                {interests.map((interest, idx) => {
                  ...
                  return (
                    <div key={idx} className="flex items-start gap-3">
                      <Icon className={`w-5 h-5 sm:w-6 sm:h-6 ${interest.color} shrink-0 mt-0.5`} />
                      <div>
                        <div className="font-medium text-text-primary text-sm sm:text-base">{interest.title}</div>
                        <div className="text-xs sm:text-sm text-text-tertiary">{interest.desc}</div>
                      </div>
                    </div>
                  );
                })}
            ...
            {/* Philosophy */}
            <div className="bg-gradient-to-r from-accent-secondary/20 to-accent-primary/20 backdrop-blur-lg rounded-xl border border-accent-secondary/20 p-4 sm:p-6">
              <h4 className="font-bold text-accent-secondary mb-3 text-center text-sm sm:text-base">{t('philosophy.title')}</h4>
              <blockquote className="text-center italic text-text-primary mb-3 sm:mb-4 text-sm sm:text-base">
        ...
        <div className="bg-gradient-to-r from-surface-hover/80 to-surface-elevated/80 backdrop-blur-lg rounded-2xl border border-border p-6 sm:p-8">
          <h3 className="text-xl sm:text-2xl font-bold text-center mb-6 sm:mb-8 bg-gradient-to-r from-accent-primary via-accent-primary to-accent-secondary bg-clip-text text-transparent">
            {t('softSkills.title')}
          </h3>
              ...
              return (
                <div key={idx} className="text-center space-y-3">
                  <div className="w-12 h-12 sm:w-16 sm:h-16 bg-accent-secondary/20 rounded-full flex items-center justify-center mx-auto">
                    <Icon className="w-6 h-6 sm:w-8 sm:h-8 text-accent-secondary" />
                  </div>
                  <h4 className="font-bold text-accent-secondary text-sm sm:text-base">{skill.title}</h4>
                  <p className="text-xs sm:text-sm text-text-tertiary">{skill.desc}</p>
                </div>
              );
            })}
          </div>
